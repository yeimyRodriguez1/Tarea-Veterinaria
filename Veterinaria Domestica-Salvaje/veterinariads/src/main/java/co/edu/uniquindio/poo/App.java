...
public class App {
    ...
    dueño1.agregarDueñoMascota(gato1); 
    dueño2.agregarDueñoMascota(perro1); 

    //Agragación mascotas a la veterinaria
    ...
    veterinaria.AgregarMascota(aguila);
    veterinaria.AgregarMascota(canario);
    veterinaria.AgregarMascota(leon);
